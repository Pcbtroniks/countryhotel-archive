  ...
  <body>
    ...
    <div class="container">
		<div class="row">
			...
			<div class="span2"></div>
			<div class="span8">
				<h4 class="title-bg">CONSULT BOOKING</h4>
				<p>Please fill out the following form to request a reservation without charge at this time. We will contact you as soon as possible.</p>
            </div>
        </div>
    </div>
