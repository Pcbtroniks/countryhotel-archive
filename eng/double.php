  ...
  <body>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> DOUBLE Room</h4>
			...
			<div class="span4">
    			<div class="greyBox">
	            	...
	            	<p>
	            	<h2>17 Rooms</h2></p>
                   <i class="icon-circle-arrow-right"></i>Two full size beds</li><br><br><br>
            	  <i class="icon-circle-arrow-right"></i>Air conditioned</li><br><br><br>
                 
                    <i class="icon-circle-arrow-right"></i>Fridge</li>*<br><br><br>
                  <i class="icon-circle-arrow-right"></i>Microwave</li>*<br><br><br>
...
<br><br><br><br><br><br><br>
					...
					<a href="master.php">MASTER Room</a><br>
