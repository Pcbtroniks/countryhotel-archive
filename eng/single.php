  ...
  <body>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> SINGLE Room</h4>
			...
			<div class="span4">
    			<div class="greyBox">
                   ...
                   <i class="icon-circle-arrow-right"></i>One King Size Bed
                   </li><br><br><br>
            	  <i class="icon-circle-arrow-right"></i>Air conditioned</li><br><br><br>
                  
                  
                  <i class="icon-circle-arrow-right"></i>Cable TV
                  </li><br><br><br>
...
<br><br><br><br><br><br><br>
					...
					<div class="button_green">
					<a href="double.php">DOBLE Room</a>
					</div><!-- End of button green -->
					<br>
					<br>
