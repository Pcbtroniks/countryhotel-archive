  ...
  <body>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> MASTER Room</h4>
				<p><img src="assets/img/habMASTER.jpg" alt=""></p>
			</div><!-- /span8 -->
			
			<div class="span4">
    			<div class="greyBox">
	            	<h4 class="title-bg">Information</h4>
	            	<p><h2>21 Rooms</h2></p>
                   <i class="icon-circle-arrow-right"></i>Two king size beds</li><br><br><br>
            	  <i class="icon-circle-arrow-right"></i>Air conditioned</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Kitchenette*</li><br><br><br>
                    <i class="icon-circle-arrow-right"></i>Fridge</li>*<br>
                    <br><br>
                  <i class="icon-circle-arrow-right"></i>Microwave</li>*<br>
                  <br><br>
                  <i class="icon-circle-arrow-right"></i>Living room</li>*<br><br><br>
                  <i class="icon-circle-arrow-right"></i>Cable TV</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Desk</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Bathroom</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Bathtub</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Hair dryer</li><br>
<br><br><br><br><br><br><br>
	            	<br><p align="right">*Subject to availability</p>
	            	<div class="button_green">
					<a href="double.php">DOUBLE Room</a><br>
					</div><!-- End of button green -->
                     	<!-- Start of button green -->
					<div class="button_green">
					<a href="single.php">SINGLE Room</a>
					</div><!-- End of button green -->
                    <br>
					<br>
    			</div>
                <br><br><br><p><a href="https://hotels.cloudbeds.com/reservation/bBd28o"><img src="assets/img/reserva.png" width="369" height="119"></a></p><!-- /greybox -->
			</div><!-- /span4 -->
		</div><!-- /row -->
		<br>
		<br>
