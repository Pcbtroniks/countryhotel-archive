...
<html lang="en">
		...
		<div id="myCarousel" class="carousel slide">
	        <div class="carousel-inner">
  				<div class="item active">
    				<img src="assets/img/sliders/carousel01.jpg" alt="">
  				</div><!-- /item -->
  				<div class="item">
    				<img src="assets/img/sliders/carousel02.jpg" alt="">
  				</div><!-- /item -->
  				<div class="item">
    				<img src="assets/img/sliders/carousel03.jpg" alt="">
  				</div><!-- /item -->
			</div><!-- /carousel-inner -->
  ...
  <div class="container">
    	<div class="row">
    		...
    		<h2>WELCOME TO COUNTRY HOTEL & SUITES</h2>
    		<br>
	    		<div class="span3">
	    			<p><strong>Book Now</strong><a class="mask1" href="reservacion.php"><img src="assets/img/reserv.png" alt=""></a>
    		  ...
    		  <!-- /span3 -->
	    		<div class="span3">
   				  <p><strong>Our Hotel</strong><a class="mask1" href="ourhotel.php"><img src="assets/img/nhotel.png" alt=""></a>
    		  ...
    		  <!-- /span3 -->
	    		<div class="span3">
	    			<p><strong>Services</strong><a class="mask1" href="services.php"><img src="assets/img/servicegeneral.png" alt=""></a><br>
    		  </p>
    		  </div>
    		  <!-- /span3 -->
	    		<div class="span3">
    ...
    <div id="blackwrap">
    	<div class="container">
	    	<h1>¡Our facilities are constantly being updated for you!</h1>
	    	<p>&nbsp;</p>
	...
	<!-- Clients Logo --><!-- container --><!-- /container -->
