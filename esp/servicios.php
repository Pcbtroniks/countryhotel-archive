  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="index.php"><img src="assets/img/logosmall.png" alt="Country Hotel and SuitesCountry Hotel and Suites"></a>
    ...
    <div class="container">
    	<div class="row middle">
    		<h1>Servicios de calidad para tu propia experiencia</h1>
    	</div><!-- row -->
    </div><!-- container -->
		...
		<div id="myCarousel" class="carousel slide">
	        <div class="carousel-inner">
  				<div class="item active">
  					<div class="middle">
  					  <h2>75 Cómodas y Amplias Habitaciones</h2>
	  					<p>TOTALMENTE REMODELADAS</p>
    					<img src="assets/img/service01b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
  				<div class="item">
  					<div class="middle">
	  					<h2>Aire Acondicionado</h2>
	  					<p>EN CADA UNA DE NUESTRAS 56 HABITACIONES</p>
    					<img src="assets/img/service02b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                
  				<div class="item">
  					<div class="middle">
	  					<h2>Alberca Climatizada</h2>
	  					<p>CON UNA PROFUNDIDAD MAXIMA DE 2.10 MTS.</p>
    					<img src="assets/img/service03b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                ...
                <div class="item">
  					<div class="middle">
    					...
    					<img src="assets/img/service04b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                
                <div class="item">
  					<div class="middle">
	  					<h2>Restaurante La Floresta</h2>
	  					<p>HORARIO 7:00 A 12:00HRS.</p>
    					<img src="assets/img/service12b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                ...
                <div class="item">
  					<div class="middle">
	  					<h2>TV por Cable</h2>
	  					<p>CONTAMOS CON 57 CANALES</p>
    					<img src="assets/img/service05b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                
                <div class="item">
  					<div class="middle">
	  					<h2>Lavandería y Tintorería</h2>
	  					<p>SOLICITUD DE SERVICIO ANTES DE LAS 10 AM, SON ENTREGADOS EL MISMO DÍA</p>
    					<img src="assets/img/service06b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
  				...
  				<div class="item">
  					<div class="middle">
	  					<h2>Estacionamiento Techado y Privado</h2>
	  					<p>50 ESPACIOS DISPONIBLES</p>
    					<img src="assets/img/service07b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                
                 <div class="item">
  					<div class="middle">
	  					<h2>Servicio Teléfonico</h2>
	  					<p>TODAS NUESTRAS HABITACIONES CUENTAN CON TELÉFONO</p>
    					<img src="assets/img/service08b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                 ...
                 <div class="item">
  					<div class="middle">
	  					<h2>Cocineta*</h2>
	  					<p>*EN ALGUNAS DE NUESTRAS HABITACIONES MASTER SUITES</p>
    					<img src="assets/img/service10b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                ...
                <div class="item">
  					<div class="middle">
	  					<h2>Frigo Bar*</h2>
	  					<p>*PREVIA SOLICITUD DEL SERVICIO</p>
    					<img src="assets/img/service09b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
                
                  <div class="item">
  					<div class="middle">
	  					<h2>Horno de Microondas*</h2>
	  					<p>*PREVIA SOLICITUD DEL SERVICIO</p>
    					<img src="assets/img/service11b.png" alt="">
  					</div><!-- middle -->
  				</div><!-- item -->
