  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="alert_green">
   		<p align="center" class=""><i class="icon-map-marker"></i>Av. Circ. Jorgé Álvarez del Castillo No 1482 | Col. Chapultepec Country C.P. 44620 | Guadalajara Jalisco, México<br> <br> 
   		  <span class="lead2">Tel. 01(33) 3823.0492 - </span><a href="mailto:reservaciones@countryhotel.com.mx" target="_blank"><span class="lead2">reservaciones@countryhotel.com.mx</span></a>
    	</div><!--/alert green -->
				        ...
				        <div class="row">
			            	<div class="span6">
			                	<form action="form.php" method="POST" id="contact">
			                    	<b><span>Nombre y Apellido</span></b>
			                    	<input type="text" id="nombre" name="nombre"  required>
                                    <b><span>Email</span></b>
		                    	  <input type="text" id="email" name="email"  required>
                                 <b><span>Mensaje</span></b>
			                    	<div class="textarea-container"><textarea id="mensaje" name="mensaje"  required></textarea></div>
