...
<html lang="en">
  <head>
	...
	/* Botón de Reservar en el centro */
        .reserve {
  ...
  <body>
            ...
            <ul class="nav">
            	...
            	<li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                    	...
                    	<li class="active"><a href="#">Habitación Sencilla</a></li>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> Habitación SENCILLA</h4>
				<p><img src="assets/img/habSENCILLA.jpg" alt=""></p>
			</div><!-- /span8 -->
			...
			<div class="span4">
    			<div class="greyBox">
	            	...
	            	<p>
	            	<h2>18 Habitaciones</h2></p>
                   <i class="icon-circle-arrow-right"></i> Habitación con cama King Size</li><br><br><br>
...
<br><br><br><br><br><br><br>
					...
					<div class="button_green">
					<a href="doble.php">Habitación DOBLE</a>
					</div><!-- End of button green -->
					<br>
					<br>
    			</div><br><br><br><!-- /greybox -->
