  ...
  <body>
            ...
            <ul class="nav">
            	...
            	<li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                    	...
                    	<li class="active"><a href="#">Habitación Doble</a></li>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> Habitación DOBLE</h4>
				<p><img src="assets/img/habDOBLE.jpg" alt=""></p>
			</div><!-- /span8 -->
			...
			<div class="span4">
    			<div class="greyBox">
	            	...
	            	<p>
	            	<h2>17 Habitaciones</h2></p>
                   <i class="icon-circle-arrow-right"></i> Habitación con 2 camas matrimoniales</li><br><br><br>
            	  <i class="icon-circle-arrow-right"></i> Aire Acondicionado</li><br><br><br>
                 
                    <i class="icon-circle-arrow-right"></i>Frigo Bar</li>*<br><br><br>
                  <i class="icon-circle-arrow-right"></i>Horno de Microondas</li>*<br><br><br>
...
<br><br><br><br><br><br><br>
					...
					<a href="master.php">Habitación MASTER</a><br>
