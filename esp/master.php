  ...
  <body>
            ...
            <ul class="nav">
            	...
            	<li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                    	<li class="active"><a href="#">Habitación Master</a></li>
    ...
    <div class="container">
		<div class="row">
			...
			<br>
			<div class="span8">
				<h4 class="title-bg"> Habitación MASTER</h4>
				<p><img src="assets/img/habMASTER.jpg" alt=""></p>
			</div><!-- /span8 -->
			
			<div class="span4">
    			<div class="greyBox">
	            	<h4 class="title-bg">Información</h4>
	            	<p><h2>21 Habitaciones</h2></p>
                   <i class="icon-circle-arrow-right"></i> 2 Cuartos independientes con cama King Size</li><br><br><br>
            	  <i class="icon-circle-arrow-right"></i> Aire Acondicionado</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Cocineta*</li><br><br><br>
                    <i class="icon-circle-arrow-right"></i>Frigo Bar</li>*<br>
                    <br><br>
                  <i class="icon-circle-arrow-right"></i>Horno de Microondas</li>*<br>
                  <br><br>
                  <i class="icon-circle-arrow-right"></i>Sala</li>*<br><br><br>
                  <i class="icon-circle-arrow-right"></i>TV por Cable</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Escritorio</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Baño Completo</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Tina de Baño</li><br><br><br>
                  <i class="icon-circle-arrow-right"></i>Secadora de Cabello</li><br>
<br><br><br><br><br><br><br>
	            	<br><p align="right">*Sujeto a disponibilidad</p>
	            	<div class="button_green">
					<a href="doble.php">Habitación DOBLE</a><br>
					</div><!-- End of button green -->
                     	<!-- Start of button green -->
					<div class="button_green">
					<a href="sencilla.php">Habitación SENCILLA</a>
					</div><!-- End of button green -->
                    <br>
					<br>
    			</div>
                <br><br><br><p><a href="reservacion.php"><img src="assets/img/reserva.png" width="369" height="119"></a></p><!-- /greybox -->
			</div><!-- /span4 -->
		</div><!-- /row -->
		<br>
		<br>
